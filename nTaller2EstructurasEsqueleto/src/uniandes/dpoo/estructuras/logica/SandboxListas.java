...
public class SandboxListas
{
    ...
    public int[] getEnterosComoArreglo( )
    {
    	...
    	int [] nuevo= new int[listaEnteros.size()];
    ...
    public void reiniciarArregloCadenas( List<Object> objetos )
    {
    	...
    	for (Object i : objetos) {
    		listaCadenas.addLast(i.toString());
    	}
    }
    ...
    public int contarEnterosRepetidos( )
    {
        ...
        for (int i=0; i<getCantidadEnteros(); i++) {
        	...
        	while (encontrado && posicion <getCantidadEnteros()) {
        		if (entero == listaEnteros.get(posicion) && posicion != i
    ...
    public void generarEnteros( int cantidad, int minimo, int maximo )
    {
    	...
    	for (int i=0; i<cantidad; i++) {
    		listaEnteros.addLast((int)(Math.random()*(maximo-minimo+1)) +minimo);
    	}
    }
